  ...
  return (
    <div  ref={aboutRef} className="about-section">
      ...
      <div className="py-5">
        ...
        <div className="grid gap-2 grid-cols-5 sm:grid-cols-2 mt-5 hover:animate-none">
          {skills.map((skill, index) => (
            <div key={index} className="text-tertiery  animate-bounce     bg-sky-900 hover:bg-red-600 hover:text-white border border-tertiery py-3 px-10">
              <h1 >{skill} </h1>
            </div>
          ))}
        </div>
